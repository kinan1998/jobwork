                ...
                <div class="card">
                    <div class="card-body">
                        <div class="main-content-label mg-b-5">
                            {{__('route.add_scope_work')}}
                        </div>
                       
                        <form action="{{route('scope_work.store')}}" enctype="multipart/form-data" data-parsley-validate="" method="POST" >
                            @csrf
                            <div class="row row-sm">
                                ...
                                <div class="col-6">
                                    <div class=" avatar-xxl d-none d-sm-block">
                                        <img id="image-preview" alt="" class="rounded-circle" src="">
                                    </div>
                                </div>
